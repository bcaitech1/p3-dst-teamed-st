...
from models import SOMDST_pre, masked_cross_entropy_for_value, SOMDST
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval_batch_size", type=int, default=45)
    parser.add_argument("--model_name", type=str, default=f"coco_dst/model-45.bin")
    ...
    json.dump(
        predictions,
        open(f"{args.output_dir}/predictions-{args.num}.csv", "w"),
        indent=2,
        ensure_ascii=False,
    )
