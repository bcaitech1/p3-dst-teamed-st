...
from preprocessor import TRADEPreprocessor, SUMBTPreprocessor, TRADEPreprocessorTest
...
def train(args):
    ...
    if args.wandb_name:
        ...
        save_dir = f"{args.model_dir}/{args.model}"
    ...
    #
    # with open('trade_data/train_features_test.bin', 'wb') as f:
    #     pickle.dump(train_features, f)
    # with open('trade_data/dev_features_test.bin', 'wb') as f:
    #     pickle.dump(dev_features, f)
    # with open('trade_data/dev_labels_test.bin', 'wb') as f:
